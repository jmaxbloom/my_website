...
myStocks_returns_total%>%
  summarize(PV_Return = sum(weight*return),beta = sum(weight*beta),alpha = (PV_Return - .015)-beta*(PV_Return-.256)) %>% kableExtra::kable(color = white) %>% kableExtra::kable_classic()
